...
class WikihowTechTopics::Scraper
    ...
    def self.get_content_urls
        ...
        content_urls = home_page.css(".thumbnail").children.css("a").map { |content_link| content_link.text }
    ...
    def self.get_titles_from_content_urls
        ...
        popped_titles = titles_from_content_arrays.pop(5)
        popped_titles.collect do |raw_title| 
